...
public class WorldParameters extends AnnotatedPropertied {
	...
	@EditableProperty(group = "Disease", description = "Probability that a test is available and positive", lower = "0.0", upper = "1.0", readOnly = false)
	public double probTestPositive = 0.05;
	@EditableProperty(group = "Disease", description = "Probability of clinical diagnosis when test is negative", lower = "0.0", upper = "1.0", readOnly = false)
	public double probClinicalDiagnosis = 0.5;
	@EditableProperty(group = "Disease", description = "Reporting model: LLM (decision bank) or LR (logistic regression)", lower = "LLM", upper = "LR", readOnly = false)
	public String reportingModel = "LLM";
