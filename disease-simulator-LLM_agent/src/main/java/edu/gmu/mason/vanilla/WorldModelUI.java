...
public class WorldModelUI extends ChartedGUIState {
	...
	public WorldModelUI(WorldParameters params, BiasParameters biasParameters, BiasSingleParameters biasSingleParameters, String decisionBankPath) throws IOException, Exception {
		super(new WorldModel(params.seed, params, biasParameters, biasSingleParameters, decisionBankPath));
	}
	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				System.err.println("WARNING: Could not find a configuration file:"
			...
			try {
				...
				System.err.println("WARNING: Could not find a bias configuration file:"
			...
			String bankArg = WorldModel.argumentForKey("-decision.bank", args);
			String decisionBankPath = (bankArg != null) ? bankArg : "decision_bank.csv";

			new WorldModelUI(params, biasParameters, biasSingleParameters, decisionBankPath).createController();
